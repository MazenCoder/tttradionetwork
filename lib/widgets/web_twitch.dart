...
class WebTwitch extends StatefulWidget {
  final String url;
  WebTwitch(this.url);
  @override
  _WebTwitchState createState() => _WebTwitchState(url);
}

class _WebTwitchState extends State<WebTwitch> {
  final String url;
  _WebTwitchState(this.url);
